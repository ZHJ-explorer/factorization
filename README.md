...
2. **测试流程**：
   - 对每个数字，使用 Pollard-Rho 算法运行 5 次，取平均时间。
...
1. Pollard, J. M. (1975). "A Monte Carlo method for factorization". BIT Numerical Mathematics.
2. Miller, Gary L. (1976). "Riemann's hypothesis and tests for primality". Journal of Computer and System Sciences.
3. Rabin, Michael O. (1980). "Probabilistic algorithm for testing primality". Journal of Number Theory.